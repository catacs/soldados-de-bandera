...
public class MySoldier extends CSoldier {
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////
	/**Decides if agent accepts the CFB request This method is a decision function 
	 * invoked when a CALL FOR BACKUP request has arrived. Parameter sContent is the
	 * content of message received in CFB responder behaviour as result of a CallForBackup
	 * request, so it must be: ( x , y , z ) ( SoldiersCount ) . By default, the return value
	 * is TRUE, so agents always accepts all CFB requests. 
