...
public class MyMedic extends CMedic {
	...
	protected void setup() {
		...
		// cuando alcanza el destino, ejecutar una tarea que vaya a una posicion aleatoria
	/*
		// mostrar posicion y distancia hasta el destino
		super.addBehaviour(new CyclicBehaviour() {
			@Override
			public void action() {
				double dwActX = m_Movement.getPosition().x; 
				double dwActY = m_Movement.getPosition().y; 
				double dwActZ = m_Movement.getPosition().z;
				
				double dwDestX = m_Movement.getDestination().x - dwActX; 
				double dwDestY = m_Movement.getDestination().y - dwActY; 
				double dwDestZ = m_Movement.getDestination().z - dwActZ;
				
				System.out.println("Actual X:" + dwActX + " Y:" + dwActY + " Z: " + dwActZ);
				System.out.println("Destino X:" + dwDestX + " Y:" + dwDestY + " Z: " + dwDestZ);
				System.out.println();
				try {
					System.in.read();
				} catch (IOException e) {
